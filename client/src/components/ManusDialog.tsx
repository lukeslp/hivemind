...
export function ManusDialog({
  ...
  return (
    ...
    >
      <DialogContent className="py-5 bg-card rounded-[20px] w-[400px] shadow-lg border backdrop-blur-2xl p-0 gap-0 text-center">
        ...
        <DialogFooter className="px-5 py-5">
          ...
          <Button
            onClick={onLogin}
            className="w-full h-10 bg-primary text-primary-foreground hover:bg-primary/90 rounded-[10px] text-sm font-medium leading-5 tracking-[-0.154px]"
          >
            Login with Manus
          </Button>
        </DialogFooter>
